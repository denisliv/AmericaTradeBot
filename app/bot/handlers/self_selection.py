...
async def process_new_search_button_press(callback: CallbackQuery, state: FSMContext):
...
async def process_brand_button_press(callback: CallbackQuery, state: FSMContext):
...
async def process_model_button_press(callback: CallbackQuery, state: FSMContext):
    await callback.answer(
...
async def process_drive_button_press(callback: CallbackQuery, state: FSMContext):
    await callback.message.edit_text(
